    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Use tis Webhook URL in your Google Form's Apps Script to trigger
        ...
        <div className="space-y-4">
         ...
         <div className="rounded-lg bg-muted p-4 space-y-2">
          ...
          <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
            ...
            <li>click the three dots menu ➡️ Script editor </li>
            <li>Copy and paste the script below</li>
            <li>Replace WEBHOOK_URL with your webhook URL above</li>
            <li>Save and click "Triggers" ➡️ Add Trigger </li>
            <li>Choose: Form form ➡️ On form submit ➡️ Save</li>
          </ol>
         </div>
